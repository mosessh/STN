                                    ...
                                    <div class="table-responsive">
                                        <table class="table tabe-hover table-bordered" id="list">
                                            ...
                                            <tbody>
                                                <?php
                                                $i = 1;
                                                $qry = $conn2->query("SELECT * from phone ORDER BY Date desc");
                                                while($row= $qry->fetch_assoc()):
                                                ?>
                                                <tr>
                                                    <th class="text-center"><?php echo $i++ ?></th>
                                                    <td><b><?php echo ucwords($row['phone_n']) ?></b></td>
                                                    ...
                                                    <td class="text-center">
                                                        ...
                                                        <a class="dropdown-item view_staff" href="sms.php?id=<?php echo $row['id'] ?>" data-id="<?php echo $row['id'] ?>">compose message</a>
