                                    ...
                                    <div class="table-responsive">
                                        <table class="table tabe-hover table-bordered" id="list">
                                            ...
                                            <tbody>
                                                <?php
                                                $i = 1;
                                                $qry = $conn2->query("SELECT * from sms_status where amount ='50' ORDER BY Datec desc");
                                                ...
                                                <tr>
                                                    ...
                                                    <td><b><?php echo $row['amount'] ?></b></td>
                                                        ...
                                                        <?php if($row['amount'] =='0'): ?>
                                                            <span class="badge badge-warning">1hr Free Plan</span>
                                                        <?php elseif($row['amount'] =='30'): ?>
                                                            <span class="badge badge-success">3mbps for 6hrs</span>
                                                        <?php elseif($row['amount'] =='50'): ?>
                                                            <span class="badge bg-primary">4mbps for 10hrs</span>
