      ...
      <nav class="mt-2">
        ...
        <?php if($_SESSION['login_type'] == 1): ?>
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="./index.php?page=smstatus" class="nav-link nav-smstatus tree-item">
                  <i class="fas fa-angle-right nav-icon"></i>
                  <p>Purchase </p>
                </a>
              </li>
              ...
              <li class="nav-item">
                <a href="./index.php?page=All-Attempts" class="nav-link nav-All-Attempts tree-item">
                  <i class="fas fa-angle-right nav-icon"></i>
                  <p>All-Attempts</p>
                </a>
              </li>  
                  <li class="nav-item">
                <a href="./index.php?page=stn30" class="nav-link nav-30 tree-item">
                  <i class="fas fa-angle-right nav-icon"></i>
                  <p>30 Subscriptions Attempts</p>
                </a>
              </li>
              
                  <li class="nav-item">
                <a href="./index.php?page=stn50" class="nav-link nav-50 tree-item">
                  <i class="fas fa-angle-right nav-icon"></i>
                  <p>50 Subscriptions Attempts</p>
                </a>
              </li>
                 <li class="nav-item">
                <a href="./index.php?page=stn90" class="nav-link nav-stn90 tree-item">
                  <i class="fas fa-angle-right nav-icon"></i>
                  <p>90 Subscriptions Attempts</p>
                </a>
              </li>
              
              <li class="nav-item">
                <a href="./index.php?page=free" class="nav-link nav-free tree-item">
                  <i class="fas fa-angle-right nav-icon"></i>
                  <p>Free Subscriptions Attempts</p>
                </a>
              </li>
            </ul>
          </li>
