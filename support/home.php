...
<?php if($_SESSION['login_type'] == 1): ?>
        ...
        <div class="row">
          ...
          <div class="col-12 col-sm-6 col-md-3">
            <div class="info-box mb-3">
              <span class="info-box-icon bg-dager elevation-1"><i class="fas fa-columns"></i></span>

              <div class="info-box-content">
                <span class="info-box-text">Unsent SMS</span>
                <span class="info-box-number"><?php echo $conn2->query("SELECT * FROM sms_status where status!='Success'")->num_rows; ?></span>
              </div>
              <!-- /.info-box-content -->
            </div>
            <!-- /.info-box -->
          ...
          <div class="col-12 col-sm-6 col-md-3">
            <div class="info-box mb-3">
              ...
              <div class="info-box-content">
                <span class="info-box-text">USSD Customers</span>
                <span class="info-box-number"><?php echo $conn2->query("SELECT * FROM sms_status")->num_rows; ?></span>
              </div>
              <!-- /.info-box-content -->
            </div>
            <!-- /.info-box -->
